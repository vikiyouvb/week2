...
public class CSVProcess1
{
	...
	public CSVProcess1(String jsoninpfile,String csvinpfile,String csvoutfile) throws IOException,Exception
	{
	...
	private void operation()
	{
		...
		{	
				...
				{
					case "Integer":
					case "Double":res=String.valueOf(CSVProcess1.ops(Double.parseDouble(rval),this.ops.get(field)));break;
					case "String":res=String.valueOf(CSVProcess1.ops(rval,this.ops.get(field)));break;
				}
				temp.put(field,res);
		}
	}
	private void format() throws Exception
	{
		for(String field:this.format.keySet())
		{
				...
				{
					temp.put(field,CSVProcess1.dateFormat(rval,this.format.get(field)));
				}
		}
	}
	private void rename()
	...
	public static void main(String args[])throws Exception
	{
		...
		try
		{
			CSVProcess1 csv=new CSVProcess1(jname,csvinp,csvout);
		}
